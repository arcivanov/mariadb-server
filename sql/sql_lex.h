...
class Lex_prepared_stmt
{
  /*
    m_name contains:
    - The statement name for statements like PREPARE stmt FROM 'SELECT 1';
    - The variable name for statements like PREPARE LOCAL spvar FROM 'SELECT 1';
  */
...
public:
  ...
  bool is_for_local() const // LOCAL spvar
  {
    return m_var.rcontext_handler() != nullptr;
  }
